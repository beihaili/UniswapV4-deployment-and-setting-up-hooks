...
contract PoolManager is IPoolManager, Owned, NoDelegateCall, ERC1155, IERC1155Receiver {
    ...
    /// @inheritdoc IPoolManager
    //function settle(Currency currency) public payable override noDelegateCall onlyByLocker returns (uint256 paid) {
    function settle(Currency currency) public payable override returns (uint256 paid) {
        console.log("SETTLING0");
        uint256 reservesBefore = reservesOf[currency];
        console.log("SETTLING1");
        reservesOf[currency] = currency.balanceOfSelf();
        console.log("SETTLING2");
        paid = reservesOf[currency] - reservesBefore;
        console.log("SETTLING3");
